...
namespace ApiRest.Presentation.Extentions
{
    public static class Configure
    {
        ...
        {
            string passDecrypted = default;

            string passNormal = builder.Configuration.GetSection("ConnectionString")["PasswordNormal"];
            ...
            if (string.IsNullOrEmpty(passNormal))
                passDecrypted = Decrypter.Decrypter.Decrypt(passEncrypted);
            else
                passDecrypted = passNormal;
